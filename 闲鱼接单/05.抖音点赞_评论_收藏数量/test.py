...
# url_txt = requests.get('http://n4diee.natappfree.cc/project/workList/getVideoUrlList',verify=False)
# url_json_list = json.loads(url_txt.text)['data']
url_json_list = [{'url':'https://v.kuaishou.com/QMPnJF'}]

# call_back_url = 'http://n4diee.natappfree.cc/project/workList/getPyList'
  ...
  for url_json in url_json_list:
    ...
    # 快手部分
      ...
      try:
        ...
        # print(e)
        dict_data['url'] = 'https://v.kuaishou.com/QMPnJF'
        dict_data['favrite'] = None
        dict_data['comment'] = None
        dict_data['collect'] = None
        dict_data['share'] = None
